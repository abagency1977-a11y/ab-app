...
export const InvoiceTemplate = React.forwardRef<HTMLDivElement, InvoiceTemplateProps>(({ order, customer, logoUrl }, ref) => {
  ...
  return (
    <div ref={ref} className="bg-white text-black p-8" style={{ width: '210mm', minHeight: '297mm', fontFamily: "'Inter', sans-serif" }}>
      ...
      {/* The table will be generated by jspdf-autotable and will not be rendered from here in the final PDF */}
      <table id="invoice-items-for-pdf" className="w-full text-left mb-8 table-auto hidden">
